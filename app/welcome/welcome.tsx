  ...
  return (
      <section className="flex flex-col bg-white px-9 py-8 gap-14 shadow-xl rounded-4xl md:rounded-none md:flex-row-reverse md:py-0 md:shadow-none md:bg-transparent">
        ...
        <div className="flex flex-col items-center md:basis-1/3">
          <div className="mb-14">
            <h1 className="text-2xl text-center md:text-left">Upgrading your tea experience</h1>
            <p className="mt-6 md:text-justify">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Consectetur aut velit hic impedit illum voluptate doloremque minus
              asperiores numquam labore eligendi laboriosam sed, quis repellat
              ad aliquid rerum culpa vitae! Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus vel, deleniti corporis culpa labore dolore, vitae, cupiditate iure blanditiis officiis totam! Quaerat, obcaecati consequatur nesciunt earum consequuntur nulla accusamus velit.
            </p>
          </div>
