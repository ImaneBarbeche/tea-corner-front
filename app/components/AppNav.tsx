...
export function AppNav() {
  ...
  const settings = { icon: "settings", link: "/app/settings", text: "Settings" }

  return (
    <nav className="px-6 py-5 bg-secondary-beige rounded-full shadow-card backdrop-blur-2xl mx-4 mb-2 fixed bottom-0 left-0 right-0 md:shadow-none md:top-0 md:bottom-0 md:right-auto md:bg-transparent md:p-0 md:m-0 md:pt-1.5">
